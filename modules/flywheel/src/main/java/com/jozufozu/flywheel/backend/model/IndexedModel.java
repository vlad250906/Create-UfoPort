 ...
 *
 * <br>
 * <em>This should be favored over a normal BufferedModel.</em>
 */
public class IndexedModel implements BufferedModel {
	...
	/**
	 * Draws many instances of this model, assuming the appropriate state is already
	 * bound.
	 */
	@Override
	public void drawInstances(int instanceCount) {
		...
		GL31.glDrawElementsInstanced(primitiveMode.glEnum, ebo.getElementCount(), ebo.getEboIndexType().asGLType, 0,
				instanceCount);
	}
