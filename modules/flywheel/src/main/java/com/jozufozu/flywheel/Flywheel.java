...
public class Flywheel implements ClientModInitializer {
	...
	public static String ID = "flywheel";
	...
	public void onInitializeClient() {
		...
		ModelLoadingPlugin.register(new FlywheelModelPlugin());
	...
	class FlywheelModelPlugin implements ModelLoadingPlugin {

		@Override
		public void onInitializeModelLoader(Context pluginContext) {
			PartialModel.onModelRegistry(resloc -> pluginContext.addModels(resloc));
		}
