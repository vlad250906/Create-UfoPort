...
public abstract class InstanceManager<T> implements InstancingEngine.OriginShiftListener {
	 ...
	 *
	 * <p>
	 * {@link TickableInstance}s get ticked. <br>
	 ...
	 *
	 * <p>
	 * By default this is the only hook an IInstance has to change its internal
	 * state. This is the lowest frequency update hook IInstance gets. For more
	 * frequent updates, see {@link TickableInstance} and {@link DynamicInstance}.
	 * </p>
	 *
	...
	protected void removeInternal(T obj, AbstractInstance instance) {
		...
		LightUpdater.get(instance.world).removeListener(instance);
	}
