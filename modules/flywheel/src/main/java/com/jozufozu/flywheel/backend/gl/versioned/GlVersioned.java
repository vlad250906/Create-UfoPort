...
/**
 * This interface should be implemented by enums such that the last defined
 * variant <em>always</em> returns {@code true}
 */
public interface GlVersioned {
	 ...
	 * @return <code>true</code> if this variant is supported, or if this is the
	 *         last defined variant.
	 */
