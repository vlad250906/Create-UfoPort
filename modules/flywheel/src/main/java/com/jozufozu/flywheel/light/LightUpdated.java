...
/**
 * Marker interface for custom/fake levels to indicate that LightUpdater should
 * bother interacting with it.
 * <p>
 *
 * Implement this if your custom level has light updates at all. If so, be sure
 * to call {@link com.jozufozu.flywheel.util.WorldAttached#invalidateWorld} when
 * your level in unloaded.
 */
public interface LightUpdated extends LevelAccessor {

	/**
	 * @return {@code true} if this level is passing light updates into
	 *         LightUpdater.
	 */
