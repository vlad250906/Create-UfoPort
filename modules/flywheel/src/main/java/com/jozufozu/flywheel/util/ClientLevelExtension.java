...
public interface ClientLevelExtension {
	 ...
	 * {@link ClientLevel#entitiesForRendering()}, but the output of that method is
	 * filtered of entities that are rendered by flywheel. This interface provides a
	 * workaround.
	 * </p>
	 * 
	 * @return An iterator over all entities in the level, including entities that
	 *         are rendered by flywheel.
	 */
