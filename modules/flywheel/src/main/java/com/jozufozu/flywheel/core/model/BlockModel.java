...
public class BlockModel implements Model {
	...
	public BlockModel(ByteBuffer vertexBuffer, ByteBuffer indexBuffer, MeshData meshData, int unshadedStartVertex, String name) {
	...
	public BlockModel(ByteBuffer vertexBuffer, ByteBuffer indexBuffer, MeshData meshData, String name) {
		MeshData.DrawState drawState = meshData.drawState();
	...
	public BlockModel(ShadeSeparatedBufferedData data, String name) {
		this(data.vertexBuffer(), data.indexBuffer(), data.meshData(), data.unshadedStartVertex(), name);
	}
	...
	public static BlockModel of(BakedModel model, BlockState referenceState, PoseStack ms) {
		//System.out.println("BlockModel of shit is "+model+" "+referenceState+" "+ms);
	...
	private static class BufferEBOSupplier implements EBOSupplier {
		...
		public BufferEBOSupplier(ByteBuffer indexBufferSrc, int indexCount, IndexType indexType) {
			indexBuffer = new ByteBufferBuilder(indexBufferSrc.capacity()).build().byteBuffer();
