...
public class PartialModel {
	...
	public static void onModelRegistry(Consumer<ResourceLocation> out) {
	...
	public static void onModelBake(ModelManager manager) {
		for (PartialModel partial : ALL)
			partial.set(manager.getModel(partial.getLocation()) /*BakedModelManagerHelper.getModel(manager, partial.getLocation())*/ );
	}
