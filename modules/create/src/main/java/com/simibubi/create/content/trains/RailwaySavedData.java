...
public class RailwaySavedData extends SavedData {
	...
	@Override
	public CompoundTag save(CompoundTag nbt, Provider reg) {
...
//		Create.LOGGER.info("Saving Railway Information...");
	...
	private static RailwaySavedData load(CompoundTag nbt, Provider reg) {
...
//		Create.LOGGER.info("Loading Railway Information...");
	...
	public static RailwaySavedData load(MinecraftServer server) {
		return server.overworld()
			.getDataStorage()
			.computeIfAbsent(new SavedData.Factory<RailwaySavedData>(RailwaySavedData::new, RailwaySavedData::load, DataFixTypes.LEVEL), "create_tracks");
	}
