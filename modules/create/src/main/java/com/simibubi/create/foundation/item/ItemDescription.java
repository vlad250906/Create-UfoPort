	...
	public static class Builder {
		...
		public ItemDescription build() {
			...
			for (Pair<String, String> behaviourPair : behaviours) {
				...
				linesOnShift.addAll(
						TooltipHelper.cutStringTextComponent(behaviour, palette.primary(), palette.highlight(), 1));
			}
			...
			for (Pair<String, String> actionPair : actions) {
				...
				linesOnCtrl.addAll(
						TooltipHelper.cutStringTextComponent(action, palette.primary(), palette.highlight(), 1));
			}
			...
			return new ItemDescription(ImmutableList.copyOf(lines), ImmutableList.copyOf(linesOnShift),
