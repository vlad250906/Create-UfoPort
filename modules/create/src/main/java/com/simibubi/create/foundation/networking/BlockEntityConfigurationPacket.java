...
public abstract class BlockEntityConfigurationPacket<BE extends SyncedBlockEntity> extends SimplePacketBase {
	...
	public BlockEntityConfigurationPacket(RegistryFriendlyByteBuf buffer) {
	...
	protected abstract void writeSettings(RegistryFriendlyByteBuf buffer);

	protected abstract void readSettings(RegistryFriendlyByteBuf buffer);
