...
public class TestProcessing {
	...
	public static void precisionMechanismCrafting(CreateGameTestHelper helper) {
		...
		helper.pullLever(lever);
		if(1 == 1) {
			throw new GameTestAssertException("Precision Mechanism recipe not found");
		}
		SequencedAssemblyRecipe recipe = null; //(SequencedAssemblyRecipe) helper.getLevel().getRecipeManager()
