...
public class EncasingRegistry {
	...
	/**
	 * <strong>This method must not be called before block registration is
	 * finished.</strong>
	 */
	public static <B extends Block & EncasableBlock, E extends Block & EncasedBlock, P> void addVariant(B encasable,
			E encased) {
	...
	public static <B extends Block & EncasedBlock, P, E extends Block & EncasableBlock> NonNullUnaryOperator<BlockBuilder<B, P>> addVariantTo(
			Supplier<E> encasable) {
		return builder -> {
