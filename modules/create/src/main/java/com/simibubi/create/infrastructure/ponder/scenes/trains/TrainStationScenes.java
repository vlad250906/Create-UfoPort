...
public class TrainStationScenes {
	...
	public static void assembly(SceneBuilder scene, SceneBuildingUtil util) {
		...
		Vec3 marker = util.vector.topOf(11, 0, 6).add(0, 3 / 16f, 0);
		...
		scene.overlay.showControls(
				new InputWindowElement(marker, Pointing.DOWN).rightClick().withItem(AllBlocks.TRACK_STATION.asStack()),
				40);
		scene.idle(6);
		...
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(11, 0, 6), Pointing.RIGHT).rightClick().withItem(casing), 80);
		scene.idle(6);
		...
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(4, 0, 6), Pointing.RIGHT).rightClick().withItem(casing), 15);
		scene.idle(6);
		...
		scene.idle(20);
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(7, 0, 6), Pointing.RIGHT).rightClick().withItem(casing), 15);
		scene.idle(6);
		...
		scene.overlay.showOutline(PonderPalette.GREEN, casing,
		...
		scene.overlay.chaseBoundingBoxOutline(PonderPalette.GREEN, glue2, glue2.inflate(2, 0, 1).expandTowards(1, 3, 0),
				60);
		scene.idle(5);
		scene.overlay.chaseBoundingBoxOutline(PonderPalette.GREEN, glue1, glue1, 1);
		scene.overlay.chaseBoundingBoxOutline(PonderPalette.GREEN, glue1,
				glue1.inflate(1.25, 0, .25).expandTowards(0, 1, 0), 60);
		scene.idle(15);
		...
		ElementLink<ParrotElement> birb = scene.special.createBirb(util.vector.centerOf(10, 3, 6),
		...
		scene.overlay.showControls(new InputWindowElement(util.vector.topOf(util.grid.at(6, 0, 2)), Pointing.DOWN)
				.rightClick().withWrench(), 15);
		scene.idle(15);
	...
	public static void autoSchedule(SceneBuilder scene, SceneBuildingUtil util) {
		...
		Vec3 marker = util.vector.topOf(8, 0, 6).add(0, 3 / 16f, 0);
		...
		scene.world.animateTrainStation(stationPos, true);
		scene.idle(10);
		scene.overlay.showControls(new InputWindowElement(util.vector.topOf(stationPos), Pointing.DOWN)
				.withItem(AllItems.SCHEDULE.asStack()), 20);
		scene.idle(30);
		scene.effects.indicateSuccess(stationPos);
		scene.idle(10);
		target = util.vector.centerOf(6, 3, 6);
		scene.overlay.showLine(PonderPalette.GREEN, util.vector.topOf(stationPos).add(0, -.125, .45),
				target.add(0, 0, -.5), 40);
		scene.idle(10);
