...
public class CreateTestFunction {
	...
	public Consumer<GameTestHelper> pFunction;
	...
	protected CreateTestFunction(String fullName, String simpleName, String pBatchName, String pTestName,
		...
		testFunction = new TestFunction(pBatchName, simpleName, pStructureName, pRotation, pMaxTicks, 
				pSetupTicks, pRequired, false, pMaxAttempts, pRequiredSuccesses, false, this::run);
		this.fullName = fullName;
		this.pFunction = pFunction;
		this.pTestName = pTestName;
	...
	public void run(@NotNull GameTestHelper helper) {
		...
		pFunction.accept(CreateGameTestHelper.of(helper));
	}
}
