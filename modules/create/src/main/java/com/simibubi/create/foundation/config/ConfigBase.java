...
public abstract class ConfigBase {
	 ...
	 */
	public class ConfigGroup extends CValue<Boolean, ModConfigSpec.BooleanValue> {
	...
	public class ConfigBool extends CValue<Boolean, ModConfigSpec.BooleanValue> {
	...
	public class ConfigEnum<T extends Enum<T>> extends CValue<T, ModConfigSpec.EnumValue<T>> {
	...
	public class ConfigFloat extends CValue<Double, ModConfigSpec.DoubleValue> {
	...
	public class ConfigInt extends CValue<Integer, ModConfigSpec.IntValue> {
