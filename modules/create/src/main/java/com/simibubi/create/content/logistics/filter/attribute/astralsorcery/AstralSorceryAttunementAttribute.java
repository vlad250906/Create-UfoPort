...
//		String constellation = nbt.contains("constellation") ? nbt.getString("constellation")
//				: nbt.getString("constellationName");
//
...
//		ResourceLocation constResource = ResourceLocation.fromNamespaceAndPath(constellationName);
//		String something = Components
//				.translatable(
//						String.format("%s.constellation.%s", constResource.getNamespace(), constResource.getPath()))
//				.getString();
