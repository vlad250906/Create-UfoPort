...
public class StationSummaryDisplaySource extends DisplaySource {
	...
	protected static final List<MutableComponent> EMPTY_ENTRY_4 = ImmutableList.of(WHITESPACE,
			Components.literal(" . "), WHITESPACE, WHITESPACE);
	protected static final List<MutableComponent> EMPTY_ENTRY_5 = ImmutableList.of(WHITESPACE,
			Components.literal(" . "), WHITESPACE, WHITESPACE, WHITESPACE);
	...
	public void loadFlapDisplayLayout(DisplayLinkContext context, FlapDisplayBlockEntity flapDisplay,
		...
		FlapDisplaySection trainName = new FlapDisplaySection(trainNameWidth * MONOSPACE, "alphabet", false,
				trainNameWidth > 0);
	...
	public void initConfigurationWidgets(DisplayLinkContext context, ModularGuiLineBuilder builder,
		...
		if (isFirstLine) {
			builder.addTextInput(0, 137, (e, t) -> {
				...
				t.withTooltip(ImmutableList.of(
						Lang.translateDirect("display_source.station_summary.filter")
								.withStyle(s -> s.withColor(0x5391E1)),
						Lang.translateDirect("gui.schedule.lmb_edit").withStyle(ChatFormatting.DARK_GRAY,
		...
		builder.addScrollInput(0, 32, (si, l) -> {
			si.titled(Lang.translateDirect("display_source.station_summary.train_name_column")).withRange(0, 73)
					.withShiftStep(12);
			si.setState(50);
			l.withSuffix("%");
		}, "NameColumn");
		...
		builder.addScrollInput(36, 22, (si, l) -> {
			si.titled(Lang.translateDirect("display_source.station_summary.platform_column")).withRange(0, 16)
					.withShiftStep(4);
			si.setState(3);
		}, "PlatformColumn");
