...
public class TrackScenes {
	...
	public static void placement(SceneBuilder scene, SceneBuildingUtil util) {
		...
		ElementLink<WorldSectionElement> bgTrack = scene.world.showIndependentSection(util.select.position(11, 4, 9),
				Direction.DOWN);
		...
		ElementLink<WorldSectionElement> fgTrack = scene.world.showIndependentSection(util.select.position(3, 3, 5),
				Direction.DOWN);
		...
		scene.overlay.showControls(new InputWindowElement(startTrack, Pointing.DOWN).rightClick().withItem(trackStack),
				40);
		scene.idle(6);
		...
		scene.overlay.showControls(
				new InputWindowElement(startTrack.add(9, 0, 0), Pointing.DOWN).rightClick().withItem(trackStack), 40);
		scene.idle(6);
		...
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(8, 0, 2), Pointing.DOWN).rightClick().withItem(trackStack),
				15);
		scene.idle(15);
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(2, 0, 8), Pointing.DOWN).rightClick().withItem(trackStack),
				15);
		scene.idle(7);
		...
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(12, 0, 2), Pointing.DOWN).rightClick().withItem(trackStack),
				10);
		scene.idle(15);
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(2, 0, 12), Pointing.DOWN).rightClick().withItem(trackStack),
				10);
		scene.idle(7);
		...
		scene.overlay.showText(70).pointAt(util.vector.topOf(11, 0, 11)).colored(PonderPalette.GREEN).attachKeyFrame()
				.placeNearTarget().text("When connecting, tracks will try to make each turn equally sized");
		scene.idle(70);
		...
		scene.overlay.showControls(new InputWindowElement(util.vector.topOf(2, 0, 12), Pointing.DOWN).rightClick()
				.withItem(trackStack).whileCTRL(), 60);
		scene.idle(10);

		scene.overlay.showText(60).pointAt(util.vector.topOf(2, 0, 12)).colored(PonderPalette.GREEN).attachKeyFrame()
				.placeNearTarget().text("Holding the sprint key while connecting...");
		scene.idle(50);

		ElementLink<WorldSectionElement> longBend = scene.world.showIndependentSection(util.select.position(2, 2, 12),
				Direction.DOWN);
		...
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(12, 3, 11), Pointing.LEFT).withItem(trackStack), 30);
		scene.idle(4);
		...
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(2, 6, 11), Pointing.LEFT).withItem(trackStack), 30);
		scene.idle(4);
		scene.overlay.showControls(
		...
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(12, 2, 7), Pointing.LEFT).withItem(trackStack), 30);
		scene.idle(4);
		...
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(2, 4, 7), Pointing.LEFT).withItem(trackStack), 30);
		scene.idle(4);
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(2, 4, 7), Pointing.RIGHT).withItem(smoothStone), 26);
		scene.idle(10);
		...
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(12, 1, 3), Pointing.LEFT).withItem(trackStack), 30);
		scene.idle(4);
		...
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(2, 2, 3), Pointing.LEFT).withItem(trackStack), 30);
		scene.idle(4);
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(2, 2, 3), Pointing.RIGHT).withItem(smoothStone), 26);
		scene.idle(10);
	...
	public static void portal(SceneBuilder scene, SceneBuildingUtil util) {
		...
		ElementLink<WorldSectionElement> t1 = scene.world.showIndependentSection(util.select.fromTo(5, 2, 1, 3, 3, 2),
				Direction.DOWN);
		ElementLink<WorldSectionElement> t2 = scene.world.showIndependentSection(util.select.fromTo(5, 2, 3, 3, 3, 3),
				Direction.DOWN);
		ElementLink<WorldSectionElement> t3 = scene.world.showIndependentSection(util.select.fromTo(5, 2, 4, 3, 3, 5),
				Direction.DOWN);

		ElementLink<ParrotElement> birb = scene.special.createBirb(util.vector.centerOf(4, 3, 2),
		...
		ElementLink<WorldSectionElement> nether = scene.world.showIndependentSection(util.select.layers(7, 1),
				Direction.UP);
		scene.world.moveSection(nether, util.vector.of(0, -7, 0), 0);
		scene.special.moveParrot(birb, util.vector.of(0, 0, -.1f), 1);
		scene.idle(25);

		ElementLink<WorldSectionElement> s1 = scene.world.showIndependentSection(util.select.fromTo(5, 2, 1, 3, 3, 5),
				null);
	...
	public static void chunks(SceneBuilder scene, SceneBuildingUtil util) {
		...
		ElementLink<ParrotElement> birb = scene.special.createBirb(util.vector.centerOf(2, 2, 7),
				FacePointOfInterestPose::new);
